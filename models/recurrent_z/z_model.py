...
flags.DEFINE_boolean("use_lstm_generator", False, "Whether or not to use LSTM for generator")
flags.DEFINE_float("first_frame_loss_scalar", 0.0, "first_frame_loss_scalar")
flags.DEFINE_float("all_frames_loss_scalar", 0.0, "all_frames_loss_scalar")
...
def main(_):
    ...
    with tf.Session() as sess:
        with tf.variable_scope('video_gan'):
            vid_z_dim = 200 if FLAGS.use_lstm_generator else 120
            image_z_dim = 100
            ...
            vid_dcgan = VID_DCGAN(sess,
                                  ...
                                  use_lstm_generator=FLAGS.use_lstm_generator,
                                  first_frame_loss_scalar=FLAGS.first_frame_loss_scalar,
                                  all_frames_loss_scalar=FLAGS.all_frames_loss_scalar)
            print "DONE"
